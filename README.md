...
- This fork provide also a new feature to "force" the topic of the sentence, for that you can set in the make_sentence method
 The `topic` argument by a list of word that you want to appear to the result. Moreover, you can make a filter with `minimum_topic_words`wich is the number of words from the topic list at least you want to appear in the sentence.
